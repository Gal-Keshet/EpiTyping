...
workflow CREATE_DNA_REFERENCE {
    ...
    dna_cnn_scores_ch = CNN_SCORE_VARIANTS(dna_filtered_ch, dna_recalibrated_ch, params.ref, "${params.ref}.fai", params.ref_dict, params.exon_intervals, "${params.exon_intervals}.tbi")
